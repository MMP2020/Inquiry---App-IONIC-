...
@Component({
  selector: 'app-cooperacao',
  templateUrl: './cooperacao.page.html',
  styleUrls: ['./cooperacao.page.scss'],
})
export class CooperacaoPage implements OnInit {
  ...
  async mostrarOrientacao(id="planejamento"){

...
@Component({
  ...
  templateUrl: './investigacao.page.html',
  styleUrls: ['./investigacao.page.scss'],
})
export class InvestigacaoPage implements OnInit {
  ...
  async mostrarOrientacao(id="investigacao"){

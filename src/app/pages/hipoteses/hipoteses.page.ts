...
@Component({
  selector: 'app-hipoteses',
  templateUrl: './hipoteses.page.html',
  styleUrls: ['./hipoteses.page.scss'],
})
export class HipotesesPage implements OnInit {
  ...
  async mostrarOrientacao(id="hipo"){

...
@Component({
  selector: 'app-retomada',
  templateUrl: './retomada.page.html',
  styleUrls: ['./retomada.page.scss'],
})
export class RetomadaPage implements OnInit {
  ...
  async mostrarOrientacao(id="retomada"){

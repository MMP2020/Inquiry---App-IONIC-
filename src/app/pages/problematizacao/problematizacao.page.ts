...
@Component({
  selector: 'app-problematizacao',
  templateUrl: './problematizacao.page.html',
  styleUrls: ['./problematizacao.page.scss'],
})
export class ProblematizacaoPage implements OnInit {
  ...
  async mostrarOrientacao(id="proble"){
